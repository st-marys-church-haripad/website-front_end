      ...
      <div className='container'>
        <div id="history" className='mt-3'>
          ...
          <p className='malayalam-font fs-14 text-justify'>
            ...
            വർദ്ധിക്കുകയും പരിശുദ്ധ ദൈവമാതാവിന്റെ മദ്ധ്യസ്ഥതയിലുള്ള  അഭയാർത്ഥന വളരുകയു ചെയ്തു കൊണ്ടിരിക്കുന്നത്  ഈ കാരണത്താലാണ്. തെക്കൻ മണർകാട് എന്നറിയപ്പെടുന്ന ആരാഴിപ്പള്ളിയിലെ എട്ടുനോമ്പാചരണവും  
