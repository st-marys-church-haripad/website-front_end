    ...
    <>
      <div className='container'>
        <div id="history" className='mt-3'>
          ...
          <hr />
          <p className='malayalam-font fs-14 text-justify'>
            ...
            മാത്രമല്ല വിവിധ മതസ്ഥർക്ക്  ഈ ദേവാലയം ഒരു അത്താണിയായിരുന്നു. <br />
            ...
            നഷ്ടപ്പെട്ടു പോയ ദേവാലയം പുനഃസ്ഥാപിക്കാൻ ഉള്ള ശ്രമം ആരംഭിച്ചു.<br /> 
            ...
            പരിശുദ്ധ പരുമല തിരുമേനിയുടെ തൃക്കരങ്ങൾ കൊണ്ടാണ്. ഹരിപ്പാട് സെന്റ് മേരീസ് ഓർത്തഡോൿസ് സുറിയാനി പള്ളി എന്ന പേരിൽ പരിശുദ്ധ ദേവമാതാവിന്റെ നാമത്തിൽ 1901 ഒക്സപ്ടാബർ 23ന് (കൊല്ലവർഷം 1077
            ...
            ദൂരത്തായതിനാൽ അരനാഴിക പള്ളി എന്നും കാലാന്തരത്തിൽ ആരാഴിപ്പള്ളി എന്നും പൊതുവെ അറിയപെടുന്നതിനും ഇടയായി. ഇന്ന് ഈ ദേവാലയം തെക്കൻ മണർകാട് എന്നും അറിയപ്പെടുന്നു.....<br />
            ...
            പരിശുദ്ധ ദൈവമാതാവിനോടുള്ള മദ്ധയസ്ഥതകൾക്ക്  പേരുകേട്ട  ഈ ദേവാലയത്തിന്റെ പെരുന്നാൾ ചടങ്ങുകളും വളരെ വിപുലമായി നടത്തുന്ന പതിവാണുള്ളത്. നാനാജാതി മതസ്ഥരായ തദ്ദേശവാസികൾക്ക് ഈ ദേവാലയം 
            ...
            വർദ്ധിക്കുകയും പരിശുദ്ധ ദൈവമാതാവിന്റെ മാദ്ധ്യസ്ഥതയിലുള്ള  അഭയാർത്ഥന വളരുകയു ചെയ്തു കൊണ്ടിരിക്കുന്നത്  ഈ കാരണത്താലാണ്. തെക്കൻ മണർകാട് എന്നറിയപ്പെടുന്ന ആരാഴിപ്പള്ളിയിലെ എട്ടുനോമ്പാചരണവും  
            പെരുന്നാൾ ആഘോഷവും സെപ്റ്റംബർ മാസം 1 മുതൽ 8 വരെ തീയതികളിലാണ്.
          </p>
        </div>
